 ...
 * @author Emirhan
 */
public class FaturaSil extends javax.swing.JFrame {

    /**
     * Creates new form FaturaSil
     */
    public FaturaSil() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 440, 160, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 1200, -1));
...
DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FaturaSil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
