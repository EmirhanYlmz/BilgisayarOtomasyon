 ...
 * @author Emirhan
 */
public class FaturaDuzenle extends javax.swing.JFrame {

    /**
     * Creates new form FaturaDuzenle
     */
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 400, 120, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Fatura No", "İsim", "Soyisim", "Telefon", "İl", "İlçe", "Açık Adres", "TC Kimlik Numarası", "Ürün Tipi", "Ürün Adı", "Ürün Özellikleri", "Oluşturma Tarihi", "Tutar"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, 1200, 380));
...
try {
            FileReader fileReader = new FileReader("Faturalar.txt");
    ...
    DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
           try
        {
            BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter("Faturalar.txt"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FaturaDuzenle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FaturaDuzenle().setVisible(true);
            }
        });
    }
