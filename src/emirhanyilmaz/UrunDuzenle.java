...
public class UrunDuzenle extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(555, 530));
        setPreferredSize(new java.awt.Dimension(555, 530));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 430, 126, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ürün Numarası", "Ürün Tipi", "Ürün Adı", "Ürün Özellikleri"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 530, -1));
...
try {
            FileReader fileReader = new FileReader("Ürünler.txt");
...
DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
           try
        {
            BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter("Ürünler.txt"));
